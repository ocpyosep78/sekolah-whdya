...
if(isset($_POST['btnSimpan'])){
	...
	if (trim($txtTugas2)=="" or ! is_numeric(trim($txtUH1))) {
		$pesanError[] = "Data <b>Nilai Tugas 2</b> harus diisi angka  atau 0 !";		
	}
	if (trim($txtTugas2)=="" or ! is_numeric(trim($txtUH2))) {
		$pesanError[] = "Data <b>Nilai Tugas 2</b> harus diisi angka  atau 0 !";		
	}
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "UPDATE nilai SET semester = '$cmbSemester', kode_pelajaran = '$cmbPelajaran', 
									...
									nilai_tugas2 = '$txtTugas2', nilai_uh1 = '$txtUH1',
									nilai_uh2 = '$txtUH2', nilai_uts = '$txtNilaiUTS', 
...
$myData = mysql_fetch_array($myQry);
	...
	$dataUH1 	= isset($_POST['txtUH1']) ? $_POST['txtUH1'] : $myData['nilai_uh1'];
	$dataUH2 	= isset($_POST['txtUH2']) ? $_POST['txtUH2'] : $myData['nilai_uh2'];
