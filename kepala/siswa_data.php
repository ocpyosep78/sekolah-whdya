...
<table width="700" border="0" cellpadding="2" cellspacing="0" class="table-border">
    <tr>
      <td colspan="2" align="right"><h1 align="center"><b>DATA SISWA </b></h1></td>
    </tr>
    <tr>
      <td colspan="2">
	...
	?>
        <tr bgcolor="<?php echo $warna; ?>">
          ...
          <td width="45" align="center"><a href="cetak/siswa_cetak.php?Kode=<?php echo $Kode; ?>" target="_blank">Cetak</a></td>
          <td width="45" align="center"><a href="?open=Siswa-Edit&Kode=<?php echo $Kode; ?>" target="_self" alt="Edit Data">Edit</a> </td>
          <td width="45" align="center"><a href="?open=Siswa-Delete&Kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data"  onclick="return confirm('YAKIN AKAN MENGHAPUS DATA SISWA INI ... ?')">Delete</a></td>
        </tr>
        <?php } ?>
      </table></td>
    </tr>
