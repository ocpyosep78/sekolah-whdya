...
<table width="800" border="0" cellpadding="2" cellspacing="0" class="table-border">
  ...
  <tr>
    <td colspan="2" align="right"><h1 align="center"><b>DATA KELAS </b></h1></td>
  </tr>
  
  <tr>
    <td colspan="2"><a href="?open=Kelas-Add" target="_self"><img src="images/btn_add_data.png" height="30" border="0" /></a></td>
  </tr>
  ...
  <tr>
	...
	?>
      <tr bgcolor="<?php echo $warna; ?>">
        ...
        <td width="45" align="center"><a href="?open=Kelas-Edit&Kode=<?php echo $Kode; ?>" target="_self" alt="Edit Data">Edit</a></td>
        <td width="45" align="center"><a href="?open=Kelas-Delete&Kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA KELAS INI ... ?')">Delete</a></td>
      </tr>
      <?php } ?>
    </table></td>
  </tr>
  <tr class="selKecil">
	...
	for ($h = 1; $h <= $maksData; $h++) {
		...
		echo " <a href='?open=Kelas-Data&hal=$list[$h]'>$h</a> ";
	}
	?>	</td>
  </tr>
</table>
