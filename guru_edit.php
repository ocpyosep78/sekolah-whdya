...
if(isset($_POST['btnSimpan'])){
	...
	if(trim($txtTugas)=="") {
		$pesanError[] = "Data <b>Tugas guru </b> tidak boleh kosong, harus diisi !";		
	}
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "UPDATE guru  SET 
						...
						kelamin='$cmbKelamin', alamat='$txtAlamat',
						 tugas='$txtTugas', status_aktif='$rbAktif'
...
$myData = mysql_fetch_array($myQry); 
	...
	$dataTugas		= isset($_POST['txtTUgas']) ? $_POST['txtTugas'] : $myData['tugas'];
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="post" target="_self">
  <table class="table-list" width="100%" border="0" cellpadding="3" cellspacing="1">
    ...
    <tr>
      <td><b>Tugas Di Sd Glagah </b></td>
      <td><b>:</b></td>
      <td><input name="txtTugas" type="text" value="<?php echo $dataTugas; ?>" size="30" maxlength="25"></td>
    </tr>
    <tr>
